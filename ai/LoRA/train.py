...
# 학습 및 출력 데이터 경로
image_folder = "./data/train_van"
output_dir = "./data/output4"
...
# 파이프라인 로딩
# ✅ pipeline loading 부분만 수정됨
pipe = StableDiffusionPipeline.from_pretrained(
    "runwayml/stable-diffusion-v1-5",
    torch_dtype=torch.float32,
    safety_checker=None,
    low_cpu_mem_usage=False  # ⚠️ 이 줄만 추가됨!
).to("cuda")
...
if isinstance(pipe.text_encoder, PeftModel):
    ...
    print("⚠️ Warning: text_encoder는 PeftModel이 아닙니다. LoRA가 적용되지 않았을 수 있습니다.")
